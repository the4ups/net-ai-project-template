...
- Utilize Kilo capabilities for code analysis and refactoring.
- Follow Kilo standard practices for project navigation.
- Apply Kilo-specific tools for code optimization.
